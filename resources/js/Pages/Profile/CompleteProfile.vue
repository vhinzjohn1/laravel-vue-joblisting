...
const isStepComplete = ref({
    1: false, // Educational Background
    2: false, // Work Experience
    3: false, // Training & Certifications
});
...
const determineInitialStep = async () => {
    try {
        ...
        const [educationResponse, experienceResponse, trainingResponse] =
            await Promise.all([
                ...
                <div class="flex justify-between items-center">
                    ...
                    <div>
                        ...
                        >
                            ...
                            <i class="fas fa-sign-out-alt p-1 border rounded-md transition-colors duration-200 group-hover:bg-green-500"></i>
                        </button>
                    </div>
                </div>
            </nav>
            ...
            <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 mt-10">
                ...
                <div class="flex justify-between items-center mt-8">
                    <button
                        v-if="currentStep > 1"
                        @click="prevStep"
                        class="px-6 py-2 border-2 border-gray-300 rounded-lg hover:border-green-700 transition-colors font-medium flex items-center"
                    >
                        <svg
                            xmlns="http://www.w3.org/2000/svg"
                            class="h-5 w-5 mr-1"
                    ...
                    <div v-if="currentStep < totalSteps" class="flex space-x-4">
                        <button
                            @click="nextStep"
                        ...
                        <button
                            @click="nextStep"
                            class="px-6 py-2 bg-green-700 text-white rounded-lg hover:bg-green-800 transition-colors font-medium flex items-center"
                        >
                            Next
                            <svg
                                xmlns="http://www.w3.org/2000/svg"
