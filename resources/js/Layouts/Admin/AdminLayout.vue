    ...
    >
      ...
      <div class="flex h-16 items-center border-b border-[#023d17] px-4">
        <Link href="/" class="flex items-center">
          ...
          <span v-if="sidebarOpen" class="ml-3 text-lg font-semibold text-white"
            >Admin</span
          >
        </Link>
      </div>
    ...
    >
      <div class="relative w-full max-w-sm rounded-lg bg-white p-6 text-center">
        ...
        <p class="mb-4 text-gray-800">
          Log out of
          <span class="text-black">{{ $page.props.auth.user.email }}?</span>
        </p>
      ...
      <header class="bg-white shadow-sm sticky top-0 z-10" v-if="$slots.header">
        ...
        >
          ...
          <div class="flex items-center">
            <NotificationBell :notifications="$page.props.notifications" />
