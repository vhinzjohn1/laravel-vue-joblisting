...
import { _ as _sfc_main$2 } from "./GuestLayout-DllDUiDq.js";
...
import { _ as _sfc_main$4 } from "./TextInput-DJ5KC4cX.js";
      ...
      _push(ssrRenderComponent(_sfc_main$2, _attrs, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            _push2(`<h1 class="text-3xl font-bold text-center mb-6"${_scopeId}>Login Page</h1><form${_scopeId}><div${_scopeId}>`);
            ...
            _push2(`</div><div class="mt-4 flex items-center justify-between"${_scopeId}><label class="flex items-center"${_scopeId}>`);
            _push2(ssrRenderComponent(_sfc_main$1, {
              name: "remember",
              checked: unref(form).remember,
              "onUpdate:checked": ($event) => unref(form).remember = $event
            }, null, _parent2, _scopeId));
            _push2(`<span class="ms-2 text-sm text-gray-600"${_scopeId}>Remember me</span></label>`);
            ...
            _push2(`</div><div class="flex items-center justify-end gap-5"${_scopeId}>`);
            _push2(ssrRenderComponent(unref(Link), {
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(` Don&#39;t have an account? Register `);
                } else {
                  return [
            ...
            return [
              ...
              createVNode("h1", { class: "text-3xl font-bold text-center mb-6" }, "Login Page"),
              createVNode("form", {
